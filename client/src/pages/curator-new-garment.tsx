...
export default function CuratorNewGarmentPage() {
  ...
  const handleCameraCapture = async () => {
    // Fallback ultra-confiable en móvil: input file con capture="environment"
    // Si getUserMedia se cuelga (común en iOS/PWA/in-app browsers), abrimos la cámara nativa.
    ...
    try {
      ...
      // iOS/Safari: muchas veces necesita estar en el DOM para que play() resuelva.
      ...
      // Fallback: cámara nativa del teléfono
